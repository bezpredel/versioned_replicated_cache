...
public class SingleCacheService implements CacheServiceI {
    ...
    public SingleCacheService(CacheServiceInitializer cacheServiceInitializer) {
    ...
    private class WriteContextImpl extends ReadContextImpl implements WriteContext {
        ...
        public Collection<BasicCacheIdentifier> getAllCacheNames() {
    ...
    public String toString() {
        return "SingleCacheService#" + name;
    }
    ...
    public interface DataListener {
        void onDataChanged(SingleCacheService source, int version, List<Pair<ImmutableCacheableObject<BasicCacheIdentifier>, ImmutableCacheableObject<BasicCacheIdentifier>>> changes);
    }
